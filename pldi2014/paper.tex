...
\stxclass{\alpha}{Addr}{an infinite set of addresses}{}
\end{tabular}
...
The \scheme{impersonate-operator} and \scheme{chaperone-operator} primitives imbue the newly-created value with it.
...
\stxclass{\sigma}{Store}{\funarr{Addr}{P(Val)}}{stores}\\
\stxclass{\rho}{Env}{\funarr{Var}{\widehat{Addr}}}{environments}\\
\stxclass{\af,\aw}{Op}{\nttwo{clos}{\mathit{lam}}{\arho}}{closures}\\
\stxclasscont{\ntthr{imp}{\ell}{\af}{\aw}}{impersonators}\\
\stxclasscont{\ntthr{chap}{\ell}{\af}{\aw}}{chaperones}\\
\stxclasscont{$p$}{primitives}\\
\astxclass{\alpha}{Addr}{a \emph{finite} set of addresses}{}
\end{tabular}
