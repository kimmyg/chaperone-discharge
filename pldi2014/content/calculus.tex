...
\newcommand{\red}[2]{\begin{equation}\begin{aligned}& #1\\\rr\, & #2\end{aligned}\end{equation}}
\newcommand{\reda}[2]{$#1\rr#2$}
...
\noindent
\reda{\sexp{\ks}{\sigma}{\rho}{\appe{\ae_f}{\ae_1\,\dots\,\ae_n}}}{\sapp{\ks}{\sigma}{f}{\langle v_1,\dots,v_n\rangle}}
where $f=\A{\sigma}{\rho}{\ae_f}$ and $v_i=\A{\sigma}{\rho}{\ae_i}$ for $i=1,\dots,n$.

\subsubsection{The let Form}

\noindent
\reda{\sexp{\ks}{\sigma}{\rho}{\lete{x_1\,\dots\, x_n}{e_0}{e_1}}}{\sexp{\letk{\vx}{\rho}{e_1}::\ks}{\sigma}{\rho}{e_0}} where $\vx=\langle x_1,\dots,x_n\rangle$.

\reda{\sval{\letk{\rho}{\vx}{e_1}::\ks}{\sigma}{\vv}}{\sexp{\ks}{\sigma'}{\rho'}{e_1}}
where $(\sigma',\rho')=\bind{\vx}{\vv}$ if $|\vx|=|\vv|$

\reda{\sval{\letk{\rho}{\vx}{e_1}::\ks}{\sigma}{\vv}}{\dynbla{\ks}}
if $|\vx|\ne|\vv|$

\subsubsection{The let Form}

\reda{\sexp{\ks}{\sigma}{\rho}{\ife{\ae_t}{e_c}{e_a}}}{\sexp{\ks}{\sigma}{\rho}{e_c}}
if $v_t\ne\false$
where $v_t=\A{\sigma}{\rho}{\ae_t}$.

\reda{\sexp{\ks}{\sigma}{\rho}{\ife{\ae_t}{e_c}{e_a}}}{\sexp{\ks}{\sigma}{\rho}{e_a}}
if $v_t=\false$
where $v_t=\A{\sigma}{\rho}{\ae_t}$.
\end{figure*}
...
\noindent
\red{\sexp{\ks}{\sigma}{\rho}{\lete{x_1\,\dots\, x_n}{e_0}{e_1}}}{\sexp{\letk{\vx}{\rho}{e_1}::\ks}{\sigma}{\rho}{e_0}}
